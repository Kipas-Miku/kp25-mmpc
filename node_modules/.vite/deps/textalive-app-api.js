...
function Pn() {
  return yn(this, 0, void 0, function() {
    return gn(this, function(t) {
      return bn && bn.Player ? [2, bn] : "undefined" == typeof window ? [2, import("./main-A3PKI4XD.js")] : window.Songle && window.Songle.Player ? [2, window.Songle] : (mn || (mn = new Promise(function(t2) {
        var e2 = false;
    ...
    return gn(this, function(v2) {
      switch (v2.label) {
        case 0:
          ...
          v2.label = 1;
        case 1:
          return v2.trys.push([1, 5, , 6]), (g2 = "undefined" != typeof window && (null === window || void 0 === window ? void 0 : window.WebFont)) ? [3, 3] : [4, import("./webfontloader-CUJXRZ7E.js")];
        case 2:
